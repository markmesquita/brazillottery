...
const QuinaPage: React.FC = () => {
  ...
  const [selectedNumbers, setSelectedNumbers] = useState<number>(5)
  ...
  useEffect(() => {
    handleGamble(selectedNumbers, 0, 80)
  }, [selectedNumbers])
    ...
    <>
      ...
      <div className="flex flex-col items-center">
        ...
        <div className="w-full flex flex-col md:flex-row justify-between items-center gap-4 mt-4">
          ...
          />
          <button
            onClick={() => handleGamble(selectedNumbers, 0, 80)}
            className="bg-blue-800 px-5 py-3 rounded-md text-white hover:text-blue-800 hover:bg-blue-500 transition"
          >
            Novo jogo
          </button>
        </div>
        ...
        <div className="flex w-full flex-row justify-end flex-wrap gap-1 mt-4">
          {numbers.map(num => (
            <div key={num} className="h-6 w-8 pl-2 pr-2 text-center text-white bg-blue-800 rounded-xl flex items-center justify-center text-sm">
